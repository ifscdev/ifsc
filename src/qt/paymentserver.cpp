...
const QString BITCOIN_IPC_PREFIX("Inclusivefinancesyscoin:");
...
{
    QString name("InclusivefinancesyscoinQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Inclusivefinancesyscoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Inclusivefinancesyscoin: click-to-pay handler");
    else
...
{
    // clicking on Inclusivefinancesyscoin: URLs creates FileOpen events on the Mac:
