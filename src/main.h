...
static const int64_t MAX_MONEY = 1300000000 * COIN;
...
public:
    ...
    {
        // Inclusivefinancesyscoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Inclusivefinancesyscoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Inclusivefinancesyscoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Inclusivefinancesyscoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Inclusivefinancesyscoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Inclusivefinancesyscoin: block index flags
    enum  
    {
